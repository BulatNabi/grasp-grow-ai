...
const tokenHistory = [
  { action: "Interview: John Doe — Senior React Developer", tokens: -10, date: "Feb 8, 2026", balance: 320 },
  { action: "Interview: Jane Smith — Senior React Developer", tokens: -10, date: "Feb 7, 2026", balance: 330 },
  { action: "Token Purchase — Business Pack", tokens: +200, date: "Feb 1, 2026", balance: 340 },
  { action: "Interview: Maria Garcia — Backend Engineer", tokens: -10, date: "Jan 30, 2026", balance: 140 },
  { action: "Knowledge Base Processing", tokens: -5, date: "Jan 28, 2026", balance: 150 },
];

const packages = [
  { name: "Business", tokens: 200, price: "$39.99", popular: false },
  { name: "Growth", tokens: 500, price: "$89.99", popular: true },
  { name: "Enterprise", tokens: 2000, price: "$299.99", popular: false },
];
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-6 lg:p-8">
        <div className="max-w-5xl">
          ...
          <p className="text-sm text-muted-foreground mb-8">Manage your company token balance</p>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            {packages.map((pkg) => (
              <div key={pkg.name} className={`glass-card-hover p-5 text-center ${pkg.popular ? "gradient-border" : ""}`}>
                {pkg.popular && <span className="text-xs font-semibold text-accent mb-2 block">Most Popular</span>}
